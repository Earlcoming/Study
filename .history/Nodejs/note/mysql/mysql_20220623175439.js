...
// 更新数据便捷方式
// const user = { id: 21, username: "aaas", password: "01111" };
...
// db.query(sqlStr, 21, (err, results) => {
//   if (err) return console.log("删除数据错误", err.message);
//   if (results.affectedRows === 1) {
//     console.log("删除数据成功");
//   }
// });
...
db.query(sqlStr,[0,2], (err,results) => {
  if (err) return console.log("标记删除数据错误", err.message);
    if (results.affectedRows === 1) {
